...
<div style="width:1080px;height:1080px;background:#0a0a0f;position:relative;overflow:hidden;display:flex;flex-direction:column;justify-content:center;padding:80px 88px;">
  ...
  <div style="position:absolute;top:0;right:0;width:600px;height:400px;background:radial-gradient(ellipse at top right,rgba(249,115,22,0.18) 0%,transparent 70%);pointer-events:none;"></div>
  <!-- Gradiente inferior esquerdo -->
  <div style="position:absolute;bottom:0;left:0;width:400px;height:300px;background:radial-gradient(ellipse at bottom left,rgba(29,78,216,0.12) 0%,transparent 70%);pointer-events:none;"></div>
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:40px;">
    ...
    <div style="text-align:right;">
      ...
      <div style="font-size:52px;font-weight:900;color:#f97316;line-height:1;letter-spacing:-2px;">R$27</div>
    </div>
  </div>
