...
`<div style="width:1080px;height:1080px;background:linear-gradient(160deg,#f0fffe 0%,#e0f7f6 100%);display:flex;flex-direction:column;padding:80px;position:relative;">
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;flex:1;">
    <div style="background:white;border:2px solid #00b4ae;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px;"><div style="font-size:32px;">🤝</div><div style="font-size:19px;font-weight:800;color:#1a1a2e;">O eu, o outro e o nós</div><div style="font-size:16px;color:#777;">Empatia, convivência, identidade</div></div>
    <div style="background:white;border:2px solid #e8e8e8;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px;"><div style="font-size:32px;">🏃</div><div style="font-size:19px;font-weight:800;color:#1a1a2e;">Corpo, gestos e movimentos</div><div style="font-size:16px;color:#777;">Coordenação, expressão corporal</div></div>
    <div style="background:white;border:2px solid #e8e8e8;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px;"><div style="font-size:32px;">🎨</div><div style="font-size:19px;font-weight:800;color:#1a1a2e;">Traços, sons e cores</div><div style="font-size:16px;color:#777;">Arte, música, expressão criativa</div></div>
    <div style="background:white;border:2px solid #e8e8e8;border-radius:16px;padding:24px;display:flex;flex-direction:column;gap:10px;"><div style="font-size:32px;">📖</div><div style="font-size:19px;font-weight:800;color:#1a1a2e;">Escuta, fala e imaginação</div><div style="font-size:16px;color:#777;">Linguagem, narrativa, literatura</div></div>
  </div>
...
`<div style="width:1080px;height:1080px;background:#1a1a2e;display:flex;flex-direction:column;padding:80px;position:relative;">
  ...
  <div style="display:flex;flex-direction:column;gap:14px;flex:1;">
    <div style="display:flex;align-items:center;gap:20px;"><div style="width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#00b4ae,#00e5df);color:#1a1a2e;font-size:22px;font-weight:900;display:flex;align-items:center;justify-content:center;flex-shrink:0;">1</div><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 20px;flex:1;"><div style="font-size:19px;font-weight:800;color:white;">Abre o PDF</div><div style="font-size:15px;color:rgba(255,255,255,0.5);margin-top:3px;">Offline, sem internet, sem assinatura</div></div></div>
    <div style="display:flex;align-items:center;gap:20px;"><div style="width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#00b4ae,#00e5df);color:#1a1a2e;font-size:22px;font-weight:900;display:flex;align-items:center;justify-content:center;flex-shrink:0;">2</div><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 20px;flex:1;"><div style="font-size:19px;font-weight:800;color:white;">Escolhe o Campo de Experiência</div><div style="font-size:15px;color:rgba(255,255,255,0.5);margin-top:3px;">O campo que mais trabalhou com aquele aluno</div></div></div>
    <div style="display:flex;align-items:center;gap:20px;"><div style="width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#00b4ae,#00e5df);color:#1a1a2e;font-size:22px;font-weight:900;display:flex;align-items:center;justify-content:center;flex-shrink:0;">3</div><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 20px;flex:1;"><div style="font-size:19px;font-weight:800;color:white;">Define o nível</div><div style="font-size:15px;color:rgba(255,255,255,0.5);margin-top:3px;">Desenvolvendo · Em desenvolvimento · Consolidado</div></div></div>
    <div style="display:flex;align-items:center;gap:20px;"><div style="width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#00b4ae,#00e5df);color:#1a1a2e;font-size:22px;font-weight:900;display:flex;align-items:center;justify-content:center;flex-shrink:0;">4</div><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 20px;flex:1;"><div style="font-size:19px;font-weight:800;color:white;">Seleciona 4-5 blocos</div><div style="font-size:15px;color:rgba(255,255,255,0.5);margin-top:3px;">Textos prontos, linguagem BNCC, personalizáveis</div></div></div>
    <div style="display:flex;align-items:center;gap:20px;"><div style="width:48px;height:48px;border-radius:50%;background:linear-gradient(135deg,#00b4ae,#00e5df);color:#1a1a2e;font-size:22px;font-weight:900;display:flex;align-items:center;justify-content:center;flex-shrink:0;">5</div><div style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 20px;flex:1;"><div style="font-size:19px;font-weight:800;color:white;">Coloca o nome e pronto ✓</div><div style="font-size:15px;color:rgba(255,255,255,0.5);margin-top:3px;">Parecer único, coerente e profissional</div></div></div>
  </div>
...
`<div style="width:1080px;height:1080px;background:#fff;display:flex;flex-direction:column;padding:80px;position:relative;">
  ...
  <div style="display:flex;gap:20px;margin-bottom:24px;">
    <div style="flex:1;background:#fff5f5;border:2px solid #fdd;border-radius:20px;padding:28px;text-align:center;"><div style="font-size:48px;font-weight:900;color:#e74c3c;margin-bottom:8px;">3-4h</div><div style="font-size:18px;font-weight:700;color:#c0392b;">por aluno, antes</div><div style="font-size:15px;color:#aaa;margin-top:6px;">escrevendo do zero</div></div>
    <div style="display:flex;align-items:center;font-size:48px;color:#ccc;">→</div>
    <div style="flex:1;background:#f0fffe;border:2px solid #00b4ae;border-radius:20px;padding:28px;text-align:center;"><div style="font-size:48px;font-weight:900;color:#00b4ae;margin-bottom:8px;">10min</div><div style="font-size:18px;font-weight:700;color:#008f8a;">por aluno, depois</div><div style="font-size:15px;color:#aaa;margin-top:6px;">com os blocos prontos</div></div>
  </div>
  <div style="background:linear-gradient(135deg,#1a1a2e,#2d2d4e);border-radius:20px;padding:28px 36px;display:flex;align-items:center;justify-content:space-between;">
    <div><div style="font-size:22px;font-weight:800;color:white;">35 alunos × 4 bimestres</div><div style="font-size:16px;color:rgba(255,255,255,0.6);margin-top:4px;">= até 140 horas economizadas por ano</div></div>
...
`<div style="width:1080px;height:1080px;background:linear-gradient(145deg,#00b4ae 0%,#007a76 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:80px;position:relative;overflow:hidden;text-align:center;">
  ...
  <div style="background:white;border-radius:20px;padding:28px 60px;margin-bottom:24px;"><div style="font-size:22px;color:#888;font-weight:600;text-decoration:line-through;margin-bottom:4px;">De R$197</div><div style="font-size:56px;font-weight:900;color:#00b4ae;line-height:1;">R$97</div><div style="font-size:18px;color:#555;margin-top:4px;">pagamento único · acesso vitalício</div></div>
...
(async () => {
  ...
  for (let i = 0; i < slides.length; i++) {
    ...
    await page.screenshot({ path: `C:\\Users\\Rodrigo Cruz\\Downloads\\slide-${i+1}.png` });
